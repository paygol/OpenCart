...
class PayGol extends PaymentModule
{
    ...
    private function addState($en, $color)
    {
        ...
        if ($orderState->add()) {
            copy(dirname(__FILE__).'/views/img/paygol_logo.png', dirname(__FILE__).'/../../img/os/'.(int)$orderState->id.'.gif');
                ...
                '<form action="'.Tools::htmlentitiesUTF8($_SERVER['REQUEST_URI']).'" method="post">
                    <fieldset>
                      <legend><img src="../img/admin/contact.gif" />'.$this->l('Account details').'</legend>
                          <table border="0" width="650" cellpadding="0" cellspacing="0" id="form">
							...
							<tr><td width="130" style="height: 30px;">'.$this->l('Secret Key').':</td><td><input type="text" name="secretkey" value="'.Tools::htmlentitiesUTF8(Tools::getValue('secretkey', $this->secretkey)).'" maxlength="36" size="40" /></td></tr>
                            ...
                            <tr><td colspan="2" align="center"><br /><input class="button" name="btnSubmit" value="'.$this->l('Save').'" type="submit" /></td></tr>
                          </table>
                    </fieldset>
                </form>';
    }
