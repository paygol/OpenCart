...
Módulo de PayGol para OpenCart, versión 1.1
...
- Cargar archivo "paygol-for-opencart.1.1.ocmod.zip" via OpenCart, directamente desde el menu del administador (Tablero ->Instalador de extensiones ->Subir (botón) ->seleccionar archivo, esperar que la barra de progreso se llene.
