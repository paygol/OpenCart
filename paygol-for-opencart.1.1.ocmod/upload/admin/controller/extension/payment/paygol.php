...
class ControllerExtensionPaymentPaygol extends Controller 
{
	...
	public function index() 
	{
		...
		if (isset($this->error['receiver_id'])) {
			$data['error_receiver_id'] = $this->error['receiver_id'];
		} else {
			$data['error_receiver_id'] = '';
		}
		
		if (isset($this->error['receiver_key'])) {
			$data['error_receiver_key'] = $this->error['receiver_key'];
		} else {
			$data['error_receiver_key'] = '';
		}
	...
	protected function validate() {
		...
		if (!$this->request->post['paygol_merchant_id']) {
			$this->error['receiver_id'] = $this->language->get('error_receiver_id');
		}
		
		if (!$this->request->post['paygol_merchant_key']) {
			$this->error['receiver_key'] = $this->language->get('error_receiver_key');
		}
		return !$this->error;
	}
}